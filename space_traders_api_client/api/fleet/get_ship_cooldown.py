...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/my/ships/{shipSymbol}/cooldown".format(client.base_url, shipSymbol=ship_symbol)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, GetShipCooldownResponse200]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, GetShipCooldownResponse200]]:
    return Response(

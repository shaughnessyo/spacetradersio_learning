...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetShipNavResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetShipNavResponse200]:
    return Response(

...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetStatusResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetStatusResponse200]:
    return Response(

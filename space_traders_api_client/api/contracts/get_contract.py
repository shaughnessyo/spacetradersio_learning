...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetContractResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetContractResponse200]:
    return Response(

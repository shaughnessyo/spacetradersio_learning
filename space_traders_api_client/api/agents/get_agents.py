...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetAgentsResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetAgentsResponse200]:
    return Response(
